...
(
    ...
    merged_from_prisoner_number varchar(7),
    merged_at                   timestamp,
...
comment on column body_scan.merged_from_prisoner_number is 'Former prisoner number this record belonged to, if any';
comment on column body_scan.merged_at is 'When this record was merged from a different prisoner number, if ever';
